...
![三分恶面渣逆袭：并行并发和食堂打饭](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-2.png)
...
![雷小帅：原子性](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/thread-bring-some-problem-eba43c92-e42d-4318-a40c-b9365c32d922.png)雷小帅：原子性
...
![雷小帅：可见性](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/thread-bring-some-problem-d91ca0c2-4f39-4e98-90e2-8acb793eb983.png)雷小帅：可见性
...
![雷小帅：有序性](https://cdn.paicoding.com/tobebetterjavaer/images/thread/thread-bring-some-problem-d4e65d5f-3de1-4a1c-8ae1-02cb3bfb528c.png)雷小帅：有序性
...
![三分恶面渣逆袭：进程与线程关系](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-3.png)三分恶面渣逆袭：进程与线程关系
...
![深入浅出 Java 多线程：JMM](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240315111143.png)深入浅出 Java 多线程：JMM
...
![深入浅出 Java 多线程：线程间通信](https://cdn.paicoding.com/stutymore/javathread-20240315111130.png)深入浅出 Java 多线程：线程间通信
...
![球友对简历修改的认可。](https://cdn.paicoding.com/stutymore/javathread-眼看秋招已经开始，打算最近离职了，更新了一版简历，麻烦二哥帮我看看。.png)球友对简历修改的认可。
...
![二哥的 Java 进阶之路](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240407172652.png)二哥的 Java 进阶之路
...
![二哥的 Java 进阶之路：默认的虚拟机栈大小](https://cdn.paicoding.com/stutymore/neicun-jiegou-20231225145929.png)二哥的 Java 进阶之路：默认的虚拟机栈大小
...
![二哥的 Java 进阶之路：JIT](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jit-20240105180655.png)二哥的 Java 进阶之路：JIT
...
![技术派：并行首页内容加载](https://cdn.paicoding.com/stutymore/javathread-20250927175506.png)技术派：并行首页内容加载
...
![拿到字节的意向了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250927175050.png)拿到字节的意向了
...
![三分恶面渣逆袭：start方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-5.png)三分恶面渣逆袭：start方法
...
![三分恶面渣逆袭：线程常用调度方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-6.png)三分恶面渣逆袭：线程常用调度方法
...
![二哥的 Java 进阶之路：stop 方法源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240321111407.png)二哥的 Java 进阶之路：stop 方法源码
...
![三分恶面渣逆袭：Java线程状态变化](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-7.png)三分恶面渣逆袭：Java线程状态变化
...
![二哥的Java 进阶之路：线程中断](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20241215110907.png)二哥的Java 进阶之路：线程中断
...
![三分恶面渣逆袭：线程切换](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-8.png)三分恶面渣逆袭：线程切换
...
![三分恶面渣逆袭：上下文切换时机](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-9.png)三分恶面渣逆袭：上下文切换时机
...
![二哥的 Java 进阶之路：wait 方法必须在同步代码块中调用](https://cdn.paicoding.com/stutymore/javathread-20240308154009.png)二哥的 Java 进阶之路：wait 方法必须在同步代码块中调用
...
![二哥的Java 进阶之路：Hashtable源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20241020082126.png)二哥的Java 进阶之路：Hashtable源码
...
推荐阅读：[ /">ThreadLocal 全面解析](https://paicoding.com/column/11/
...
![三分恶面渣逆袭：ThreadLocal线程副本](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-11.png)三分恶面渣逆袭：ThreadLocal线程副本
...
![美团背景意向](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-意向可以直接接受吧？真正下了.png)美团背景意向
...
![技术派：ThreadLocal](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240316103919.png)技术派：ThreadLocal
...
![技术派实战源码：控制层拦截请求](https://cdn.paicoding.com/stutymore/javathread-20240316104501.png)技术派实战源码：控制层拦截请求
...
![技术派实战源码：从ThreadLocal中取出信息](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240316104629.png)技术派实战源码：从ThreadLocal中取出信息
...
![三分恶面渣逆袭：ThreadLoca存放用户上下文](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-12.png)三分恶面渣逆袭：ThreadLoca存放用户上下文
...
![二哥的 Java 进阶之路：ThreadLocalMap](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240407200038.png)二哥的 Java 进阶之路：ThreadLocalMap
...
![三分恶面渣逆袭：ThreadLoca结构图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-13.png)三分恶面渣逆袭：ThreadLoca结构图
...
![ThreadLocal 的结构](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240407205747.png)ThreadLocal 的结构
...
![拿到小红书 offer 的球友称赞二哥的八股和派聪明](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250919154520.png)拿到小红书 offer 的球友称赞二哥的八股和派聪明
...
![三分恶面渣逆袭：ThreadLocal内存分配](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-14.png)三分恶面渣逆袭：ThreadLocal内存分配
...
![美团转正 offer+1](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250926111135.png)美团转正 offer+1
...
![二哥的 Java 进阶之路：ThreadLocalMap 内存溢出](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240407212932.png)二哥的 Java 进阶之路：ThreadLocalMap 内存溢出
...
![二哥的Java进阶之路：expungeStaleEntry](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250428095121.png)二哥的Java进阶之路：expungeStaleEntry
...
![二哥的 Java 进阶之路：清理 entry](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240407214616.png)二哥的 Java 进阶之路：清理 entry
...
![二哥的 Java 进阶之路：replaceStaleEntry方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240407214955.png)二哥的 Java 进阶之路：replaceStaleEntry方法
...
![蚂蚁暑期的球友对星球的认可](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250926111517.png)蚂蚁暑期的球友对星球的认可
...
![三分恶面渣逆袭：ThreadLocalMap结构示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-15.png)三分恶面渣逆袭：ThreadLocalMap结构示意图
...
![三分恶面渣逆袭：ThreadLocalMap解决冲突](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-16.png)三分恶面渣逆袭：ThreadLocalMap解决冲突
...
![三分恶面渣逆袭：ThreadLocalMap扩容](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-17.png)三分恶面渣逆袭：ThreadLocalMap扩容
...
![二哥的 Java 进阶之路：子线程无法获取父线程的 ThreadLocal](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250204080442.png)二哥的 Java 进阶之路：子线程无法获取父线程的 ThreadLocal
...
![二哥的 Java 进阶之路：InheritableThreadLocal源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250204080611.png)二哥的 Java 进阶之路：InheritableThreadLocal源码
...
![二哥的 Java 进阶之路：Thread 源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250204081955.png)二哥的 Java 进阶之路：Thread 源码
...
![深入浅出 Java 多线程：Java内存模型](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jmm-f02219aa-e762-4df0-ac08-6f4cceb535c2.jpg)深入浅出 Java 多线程：Java内存模型
...
![三分恶面渣逆袭：实际线程工作模型](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-20.png)三分恶面渣逆袭：实际线程工作模型
...
![三分恶面渣逆袭：多级指令重排](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-21.png)三分恶面渣逆袭：多级指令重排
...
![三分恶面渣逆袭：双重校验单例模式异常情形](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-22.png)三分恶面渣逆袭：双重校验单例模式异常情形
...
![三分恶面渣逆袭：happens-before六大规则](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-23.png)三分恶面渣逆袭：happens-before六大规则
...
![二哥的 Java 进阶之路：as-if-serial](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-24.png)二哥的 Java 进阶之路：as-if-serial
...
![三分恶面渣逆袭：两种执行结果](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-25.png)三分恶面渣逆袭：两种执行结果
...
![三分恶面渣逆袭：volatile写插入内存屏障后生成的指令序列示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-28.png)三分恶面渣逆袭：volatile写插入内存屏障后生成的指令序列示意图
...
---这部分面试中可以不背 start--- 在 x86 架构下，通常会使用 `lock` 指令来实现写屏障，例如：
...
![三分恶面渣逆袭：volatile写插入内存屏障后生成的指令序列示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-29.png)三分恶面渣逆袭：volatile写插入内存屏障后生成的指令序列示意图
...
![三分恶面渣逆袭：volatile内存可见性](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-26.png)三分恶面渣逆袭：volatile内存可见性
...
![二哥的 Java 进阶之路：volatile的性能开销](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250920182509.png)二哥的 Java 进阶之路：volatile的性能开销
...
![Alance：多级缓存架构](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250922095159.png)Alance：多级缓存架构
...
![FynnWang：MESI](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250922095121.png)FynnWang：MESI
...
![球友腾讯转正了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250920183212.png)球友腾讯转正了
...
![三分恶面渣逆袭：monitorenter和monitorexit](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-30.png)三分恶面渣逆袭：monitorenter和monitorexit
...
![三分恶面渣逆袭：synchronized修饰同步方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-31.png)三分恶面渣逆袭：synchronized修饰同步方法
...
![博客园Zebt：Java 对象头](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250209115813.png)博客园Zebt：Java 对象头
...
![拿到美团日常了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250924160421.png)拿到美团日常了
...
![二哥的 Java 进阶之路：javap 反编译后的synchronized](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250210091501.png)二哥的 Java 进阶之路：javap 反编译后的synchronized
...
![美团技术博客：可重入锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250210095240.png)美团技术博客：可重入锁
...
![三分恶面渣逆袭：Mark Word变化](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-34.png)三分恶面渣逆袭：Mark Word变化
...
![博客园boluo1230：偏向锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250211095304.png)博客园boluo1230：偏向锁
...
![TodoCoder：自旋和阻塞的区别](https://cdn.paicoding.com/stutymore/javathread-20250211091116.png)TodoCoder：自旋和阻塞的区别
...
![博客园wade&luffy：Mark Word](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250211093552.png)博客园wade&luffy：Mark Word
...
![博客园boluo1230：轻量级锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250211094909.png)博客园boluo1230：轻量级锁
...
![三分恶面渣逆袭：锁升级简略过程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-36.png)三分恶面渣逆袭：锁升级简略过程
...
![三分恶面渣逆袭：synchronized 锁升级过程](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-37.png)三分恶面渣逆袭：synchronized 锁升级过程
...
![球友对面渣逆袭的认可非常高](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250922094514.png)球友对面渣逆袭的认可非常高
...
![三分恶面渣逆袭：synchronized和ReentrantLock的区别](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-38.png)三分恶面渣逆袭：synchronized和ReentrantLock的区别
...
![二哥的Java 进阶之路：Lock.lock() 方法源码](https://cdn.paicoding.com/stutymore/javathread-20241014102520.png)二哥的Java 进阶之路：Lock.lock() 方法源码
...
![三分恶面渣逆袭：AQS抽象队列同步器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-39.png)三分恶面渣逆袭：AQS抽象队列同步器
...
![三分恶面渣逆袭：CLH队列](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-40.png)三分恶面渣逆袭：CLH队列
...
![三分恶面渣逆袭：AQS变种CLH队列](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-41.png)三分恶面渣逆袭：AQS变种CLH队列
...
![技术派已经成功接入了 Deepseek](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250212120305.png)技术派已经成功接入了 Deepseek
...
![三分恶面渣逆袭：ReentrantLock 非公平锁加锁流程简图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-42.png)三分恶面渣逆袭：ReentrantLock 非公平锁加锁流程简图
...
![二哥的 Java 进阶之路：公平锁的源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240405234921.png)二哥的 Java 进阶之路：公平锁的源码
...
![CAS 原子性：博客园的紫薇哥哥](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20241115160840.png)CAS 原子性：博客园的紫薇哥哥
...
![二哥的 Java 进阶之路：compareAndSwapInt](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240326095144.png)二哥的 Java 进阶之路：compareAndSwapInt
...
![总线锁定：博客园的紫薇哥哥](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20241115161305.png)总线锁定：博客园的紫薇哥哥
...
![三分恶面渣逆袭：CAS三大问题](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-44.png)三分恶面渣逆袭：CAS三大问题
...
![二哥的 Java 进阶之路：AtomicStampedReference](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240429114421.png)二哥的 Java 进阶之路：AtomicStampedReference
...
![不过我会加油的](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250213151028.png)不过我会加油的
...
![三分恶面渣逆袭：Java保证原子性方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-45.png)三分恶面渣逆袭：Java保证原子性方法
...
![三分恶面渣逆袭：原子操作类](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-46.png)三分恶面渣逆袭：原子操作类
...
![The Java Trail：死锁](https://cdn.paicoding.com/stutymore/javathread-20250214130301.png)The Java Trail：死锁
...
![三分恶面渣逆袭：死锁产生必备四条件](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-48.png)三分恶面渣逆袭：死锁产生必备四条件
...
![三分恶面渣逆袭：线程死锁检测](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-49.png)三分恶面渣逆袭：线程死锁检测
...
创建两个线程，每个线程都试图按照不同的顺序获取两个[锁（lock1 和 lock2）](https://javabetter.cn/thread/thread-bring-some-problem.html#活跃性问题)。

锁的获取顺序不一致很容易导致死锁。运行这段代码，会发现两个线程都无法继续执行，进入了死锁状态。



![二哥的 Java 进阶之路：死锁发生了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/console-tools-20240106192010.png)二哥的 Java 进阶之路：死锁发生了
...
![jstack pid 查看死锁信息](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/console-tools-20240106192123.png)jstack pid 查看死锁信息
...
![cxuan：使用临界区的互斥](https://cdn.paicoding.com/stutymore/javathread-20241008102844.png)cxuan：使用临界区的互斥
...
![二哥的 Java 进阶之路：tryLock中的自旋](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250215092705.png)二哥的 Java 进阶之路：tryLock中的自旋
...
![二哥的Java 进阶之路：CountDownLatch](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20241008110023.png)二哥的Java 进阶之路：CountDownLatch
...
![秦二爷：王者荣耀等待玩家确认](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-50.jpeg)秦二爷：王者荣耀等待玩家确认
...
![三分恶面渣逆袭：CyclicBarrier工作流程](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-55.png)三分恶面渣逆袭：CyclicBarrier工作流程
...
![三分恶面渣逆袭：Semaphore](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250218091702.png)三分恶面渣逆袭：Semaphore
...
![三分恶面渣逆袭：停车场空闲车位提示](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-56.jpeg)三分恶面渣逆袭：停车场空闲车位提示
...
![三分恶面渣逆袭：英雄交换猎物](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-58.jpeg)三分恶面渣逆袭：英雄交换猎物
...
![初念初恋：JDK 7 ConcurrentHashMap](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/map-20230816155810.png)初念初恋：JDK 7 ConcurrentHashMap
...
![初念初恋：JDK 8 ConcurrentHashMap](https://cdn.paicoding.com/stutymore/map-20230816155924.png)初念初恋：JDK 8 ConcurrentHashMap
...
![球友拿到了美团的 offer](https://cdn.paicoding.com/stutymore/javathread-20250919154007.png)球友拿到了美团的 offer
...
![三分恶面渣逆袭：ConcurrentHashMap示意图](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/collection-31.png)三分恶面渣逆袭：ConcurrentHashMap示意图
...
![三分恶面渣逆袭：JDK7 put 流程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240325113351.png)三分恶面渣逆袭：JDK7 put 流程
...
![三分恶面渣逆袭：Java 8 put 流程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/collection-32.jpg)三分恶面渣逆袭：Java 8 put 流程
...
![二哥的 Java 进阶之路：TreeBin 的哈希值固定为 -2](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250220104000.png)二哥的 Java 进阶之路：TreeBin 的哈希值固定为 -2
...
![二哥的 Java 进阶之路：HashMap 和 ConcurrentHashMap 的 get 方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250220110736.png)二哥的 Java 进阶之路：HashMap 和 ConcurrentHashMap 的 get 方法
...
![二哥的 Java 进阶之路：ForwardingNode和TreeNode的 find 方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240426104658.png)二哥的 Java 进阶之路：ForwardingNode和TreeNode的 find 方法
...
![二哥的 Java 进阶之路：技术派的源码封装 ConcurrentHashMap](https://cdn.paicoding.com/stutymore/javathread-20240411082351.png)二哥的 Java 进阶之路：技术派的源码封装 ConcurrentHashMap
...
![二哥的 Java 进阶之路：ConcurrentHashMap 的源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240426105405.png)二哥的 Java 进阶之路：ConcurrentHashMap 的源码
...
![二哥的编程星球：给星球用户修改简历](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250220113043.png)二哥的编程星球：给星球用户修改简历
...
![CL0610：最终一致性](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/CopyOnWriteArrayList-01.png)CL0610：最终一致性
...
![img](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250922165408.png)
...
![三分恶面渣逆袭：管理线程的池子](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-59.png)三分恶面渣逆袭：管理线程的池子
...
比如说在[技术派实战项目](https://javabetter.cn/zhishixingqiu/paicoding.html)当中， 我们就封装了一个异步工具类 AsyncUtil，内置了可配置的线程池，基于 ThreadPoolExecutor，适用于 IO 密集型任务。



![技术派源码：AsyncUtil](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240424090143.png)技术派源码：AsyncUtil
...
![三分恶面渣逆袭：线程池执行流程](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-66.png)三分恶面渣逆袭：线程池执行流程
...
![三分恶面渣逆袭：直接办理](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-62.png)三分恶面渣逆袭：直接办理
...
![三分恶面渣逆袭：排队等待](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-63.png)三分恶面渣逆袭：排队等待
...
![三分恶面渣逆袭：排队区满](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-64.png)三分恶面渣逆袭：排队区满
...
![三分恶面渣逆袭：等待区，排队区都满](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-65.png)三分恶面渣逆袭：等待区，排队区都满
...
![三分恶面渣逆袭：线程池参数](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-67.png)三分恶面渣逆袭：线程池参数
...
![三分恶面渣逆袭：四种策略](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-68.png)三分恶面渣逆袭：四种策略
...
![三分恶面渣逆袭：线程池常用阻塞队列](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-69.png)三分恶面渣逆袭：线程池常用阻塞队列
...
![技术派实战项目源码：RabbitMQ 的消息队列](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240422100900.png)技术派实战项目源码：RabbitMQ 的消息队列
...
![球友拿到了字节跳动的实习，简历修改的时候得到了正反馈](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-靠二哥修改的简历找到的实习，现在要投秋招，麻烦二哥指导下简历怎么继续修改优化.png)球友拿到了字节跳动的实习，简历修改的时候得到了正反馈
...
![常见线程池参数配置方案-来源美团技术博客](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-70.png)常见线程池参数配置方案-来源美团技术博客
...
![球友对星球的口碑](https://cdn.paicoding.com/stutymore/javathread-偶然一机会就加入了，确实还挺好的.png)球友对星球的口碑
...
![三分恶面渣逆袭：FixedThreadPool](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-73.png)三分恶面渣逆袭：FixedThreadPool
...
![三分恶面渣逆袭：CachedThreadPool执行流程](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-74.png)三分恶面渣逆袭：CachedThreadPool执行流程
...
![三分恶面渣逆袭：SingleThreadExecutor运行流程](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-72.png)三分恶面渣逆袭：SingleThreadExecutor运行流程
...
![三分恶面渣逆袭：ScheduledThreadPool执行流程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-75.png)三分恶面渣逆袭：ScheduledThreadPool执行流程
...
![三分恶面渣逆袭：ScheduledThreadPoolExecutor执行流程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-76.png)三分恶面渣逆袭：ScheduledThreadPoolExecutor执行流程
...
![三分恶面渣逆袭：线程池异常处理](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-77.png)三分恶面渣逆袭：线程池异常处理
...
![三分恶面渣逆袭：线程池状态切换图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-78.png)三分恶面渣逆袭：线程池状态切换图
...
![祝所有考研的同学都能顺利上岸](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250224102434.png)祝所有考研的同学都能顺利上岸
...
![三分恶面渣逆袭：JDK 线程池参数设置](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-79.png)三分恶面渣逆袭：JDK 线程池参数设置
...
![三分恶面渣逆袭：动态修改线程池参数](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-80.png)三分恶面渣逆袭：动态修改线程池参数
...
![三分恶面渣逆袭：线程池调优](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javathread-82.png)三分恶面渣逆袭：线程池调优
...
![球友对简历修改的认可](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-投了1天就接面了，二哥改的简历还是太好用.png)球友对简历修改的认可
...
![三分恶面渣逆袭：线程池主要实现流程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-83.png)三分恶面渣逆袭：线程池主要实现流程
...
![二哥的 Java 进阶之路：自定义线程池](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20240727230303.png)二哥的 Java 进阶之路：自定义线程池
...
![二哥的Java 进阶之路：数据库连接池](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20241118220052.png)二哥的Java 进阶之路：数据库连接池
...
![三分恶面渣逆袭：Fork/Join分治算法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-85.png)三分恶面渣逆袭：Fork/Join分治算法
...
![三分恶面渣逆袭：工作窃取](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-86.png)三分恶面渣逆袭：工作窃取
...
![字节暑期实习 2.25 二面](https://cdn.paicoding.com/stutymore/javathread-20250226110851.png)字节暑期实习 2.25 二面
...
![Java 基础篇、集合框架篇、JVM 篇、并发编程篇](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javathread-20250226112804.png)Java 基础篇、集合框架篇、JVM 篇、并发编程篇
...
![球友开始面试后的感慨：限制敲错了是现在](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250118111727.png)球友开始面试后的感慨：限制敲错了是现在
