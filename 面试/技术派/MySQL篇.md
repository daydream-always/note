...
![二哥的 Java 进阶之路：MySQL 8.3 最新版本](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250227062838.png)二哥的 Java 进阶之路：MySQL 8.3 最新版本
...
> 6. [Java 面试指南（付费）](https://javabetter.cn/zhishixingqiu/mianshi.html)收录的vivo 面经同学 10 技术一面面试原题：怎么删除/创建一张表和设定主键 ，举例用sql实现升序降序
...
![MySQL 内连接、左连接、右连接-来源菜鸟教程](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-fcdaad5f-c50e-4834-9f9a-0b676cc6be83.jpg)MySQL 内连接、左连接、右连接-来源菜鸟教程
...
![技术派实战项目：内连接的结果](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240308184454.png)技术派实战项目：内连接的结果
...
![技术派实战项目：做连接查询结果](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240308184901.png)技术派实战项目：做连接查询结果
...
![技术派实战项目：右连接查询结果](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240308185525.png)技术派实战项目：右连接查询结果
...
![二哥编程星球的球友：小赢科技 OC了](https://cdn.paicoding.com/stutymore/mysql-20250227084922.png)二哥编程星球的球友：小赢科技 OC了
...
![三分恶面渣逆袭：数据库三范式](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-16e74a6b-a42a-464e-9b10-0252ee7ecc6e.jpg)三分恶面渣逆袭：数据库三范式
...
![Ruthless：第一范式](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240418093235.png)Ruthless：第一范式
...
![Ruthless：不符合第二范式](https://cdn.paicoding.com/stutymore/mysql-20240418093351.png)Ruthless：不符合第二范式
...
![Ruthless：订单商品关联表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240418093726.png)Ruthless：订单商品关联表
...
![Ruthless：第三范式](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240418094332.png)Ruthless：第三范式
...
![三分恶面渣逆袭：varchar和 char](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-40f42d59-a295-4543-8a03-43925da4d6d9.jpg)三分恶面渣逆袭：varchar和 char
...
![别问，问就是给的薪资待遇很 ok](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250301165545.png)别问，问就是给的薪资待遇很 ok
...
![三分恶面渣逆袭：DATETIME 和 TIMESTAMP](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-d94e5e1c-2614-4b8b-acdb-efb333032854.jpg)三分恶面渣逆袭：DATETIME 和 TIMESTAMP
...
![二哥的 Java 进阶之路：更新时不用 set 更新时间](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250301170530.png)二哥的 Java 进阶之路：更新时不用 set 更新时间
...
![二哥的 Java 进阶之路：查看 MySQL 的默认字符集](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240418103116.png)二哥的 Java 进阶之路：查看 MySQL 的默认字符集
...
![一位球友拿到了科大讯飞的 offer，春招](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250304161556.png)一位球友拿到了科大讯飞的 offer，春招
...
![二哥的 Java 进阶之路：count(*)全表扫描](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250305181629.png)二哥的 Java 进阶之路：count(*)全表扫描
...
![二哥的 Java 进阶之路：修改t1主键](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250305181907.png)二哥的 Java 进阶之路：修改t1主键
...
![二哥的 Java 进阶之路：count(*)走了索引](https://cdn.paicoding.com/stutymore/mysql-20250305182117.png)二哥的 Java 进阶之路：count(*)走了索引
...
![二哥的 Java 进阶之路：MySQL 8.0 官方手册](https://cdn.paicoding.com/stutymore/mysql-20250305183220.png)二哥的 Java 进阶之路：MySQL 8.0 官方手册
...
![球友拿到了咪咕的大模型开发实习](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250305183751.png)球友拿到了咪咕的大模型开发实习
...
![博客园数据派：查询语句执行顺序](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250306153200.png)博客园数据派：查询语句执行顺序
...
![二哥的 Java 进阶之路：MySQL常用命令](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240313093551.png)二哥的 Java 进阶之路：MySQL常用命令
...
![二哥的 Java 进阶之路：隐式转换](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240425111246.png)二哥的 Java 进阶之路：隐式转换
...
![球友拿到了经纬恒润的实习 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250308085803.png)球友拿到了经纬恒润的实习 offer
...
![三分恶面渣逆袭：Redis 的基础架构](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-77626fdb-d2b0-4256-a483-d1c60e68d8ec.jpg)三分恶面渣逆袭：Redis 的基础架构
...
![二哥的 Java 进阶之路：SQL 执行](https://cdn.paicoding.com/stutymore/mysql-20240415102041.png)二哥的 Java 进阶之路：SQL 执行
...
![三分恶面渣逆袭：update 执行](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-812fb038-39de-4204-ac9f-93d8b7448a18.jpg)三分恶面渣逆袭：update 执行
...
![不要迷恋发哥：段、区、页、行](https://cdn.paicoding.com/stutymore/mysql-20240515110034.png)不要迷恋发哥：段、区、页、行
...
![二哥的 Java 进阶之路：行格式](https://cdn.paicoding.com/stutymore/mysql-20240515123301.png)二哥的 Java 进阶之路：行格式
...
![二哥的 Java 进阶之路：存储引擎](https://cdn.paicoding.com/stutymore/mysql-20240408073338.png)二哥的 Java 进阶之路：存储引擎
...
![MySQL 官网：innodb-limits.html](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240408074630.png)MySQL 官网：innodb-limits.html
...
![三分恶面渣逆袭：InnoDB 和 MyISAM 主要有什么区别](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-b7aa040e-a3a7-4133-8c43-baccc3c8d012.jpg)三分恶面渣逆袭：InnoDB 和 MyISAM 主要有什么区别
...
![未见初墨：MyIsam](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240403130104.png)未见初墨：MyIsam
...
![yangh124：InnoDB](https://cdn.paicoding.com/stutymore/mysql-20240403130508.png)yangh124：InnoDB
...
![WindWant：InnoDB 存储引擎整体架构图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250404111739.png)WindWant：InnoDB 存储引擎整体架构图
...
![nekolr's blog：数据页结构](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250404113446.png)nekolr's blog：数据页结构
...
![GrowthDBA：User Records](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250404115235.png)GrowthDBA：User Records
...
![GrowthDBA：数据页通过双向链表连接](https://cdn.paicoding.com/stutymore/mysql-20250404115048.png)GrowthDBA：数据页通过双向链表连接
...
![二哥的 Java 进阶之路：页的大小](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240322135441.png)二哥的 Java 进阶之路：页的大小
...
![Nuwan Weerasinhge：MySQL InnoDB Buffer Pool](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250312083102.png)Nuwan Weerasinhge：MySQL InnoDB Buffer Pool
...
![极客时间：改良的 LRU 算法](https://cdn.paicoding.com/stutymore/mysql-20241104202752.png)极客时间：改良的 LRU 算法
...
![二哥的 Java 进阶之路：buffer_pool 的默认大小](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250312084307.png)二哥的 Java 进阶之路：buffer_pool 的默认大小
...
![smartkeyerror：InnoDB 的 LRU](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250312085209.png)smartkeyerror：InnoDB 的 LRU
...
![二哥的 Java 进阶之路：对 buffer pool 进行调整](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250312093325.png)二哥的 Java 进阶之路：对 buffer pool 进行调整
...
![今天有球友拿到京东和美团的 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250312172018.png)今天有球友拿到京东和美团的 offer
...
![三分恶面渣逆袭：MySQL的主要日志](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-c0ef6e68-bb33-48fc-b3a2-b9cdadd8e403.jpg)三分恶面渣逆袭：MySQL的主要日志
...
![二哥的 Java 进阶之路：MySQL 默认的 binlog格式](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250313151551.png)二哥的 Java 进阶之路：MySQL 默认的 binlog格式
...
![二哥的 Java 进阶之路：binlog 文件](https://cdn.paicoding.com/stutymore/mysql-20240417074049.png)二哥的 Java 进阶之路：binlog 文件
...
![二哥的 Java 进阶之路：开启 binlog](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240326102701.png)二哥的 Java 进阶之路：开启 binlog
...
![球友报喜字节二面过了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250313170334.png)球友报喜字节二面过了
...
![二哥的 Java 进阶之路： 我本机 MySQL 的 redolog buffer size 为 16M](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314155647.png)二哥的 Java 进阶之路： 我本机 MySQL 的 redolog buffer size 为 16M
...
![greatsql 社区：Redo Log的刷盘策略](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314160523.png)greatsql 社区：Redo Log的刷盘策略
...
![greatsql 社区：redo log 恢复](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314160157.png)greatsql 社区：redo log 恢复
...
![博客园太白金星有点烦：checkpoint](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314161732.png)博客园太白金星有点烦：checkpoint
...
![greatsql社区：redo log 文件组](https://cdn.paicoding.com/stutymore/mysql-20250314161331.png)greatsql社区：redo log 文件组
...
![greatsql社区：ib_logfile0和ib_logfile1](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314160340.png)greatsql社区：ib_logfile0和ib_logfile1
...
![二哥的 Java 进阶之路：redo log 文件大小](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314155806.png)二哥的 Java 进阶之路：redo log 文件大小
...
![小许 code：WAL](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314163343.png)小许 code：WAL
...
![球友的竞赛经历](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250314163859.png)球友的竞赛经历
...
![连边：binlog 和 redo log](https://cdn.paicoding.com/stutymore/mysql-20250315151137.png)连边：binlog 和 redo log
...
![阿里：MySQL 两阶段提交](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250316104456.png)阿里：MySQL 两阶段提交
...
![阿里：2PC 可以保证redo log 和 binlog 的数据一致性](https://cdn.paicoding.com/stutymore/mysql-20250316105500.png)阿里：2PC 可以保证redo log 和 binlog 的数据一致性
...
![mysql：xid](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250316113030.png)mysql：xid
...
![三分恶面渣逆袭：redo log 缓冲](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-e1f59341-0695-45db-b759-30db73314e39.jpg)三分恶面渣逆袭：redo log 缓冲
...
![酷酷博客园：Page Cache](https://cdn.paicoding.com/stutymore/mysql-20250317160220.png)酷酷博客园：Page Cache
...
![greatsql：innodb_flush_log_at_trx_commit](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250317155312.png)greatsql：innodb_flush_log_at_trx_commit
...
![二哥的 Java 进阶之路：innodb_flush_log_at_trx_commit的默认值](https://cdn.paicoding.com/stutymore/mysql-20250317160701.png)二哥的 Java 进阶之路：innodb_flush_log_at_trx_commit的默认值
...
![greatsql：InnoDB 的后台线程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250317161008.png)greatsql：InnoDB 的后台线程
...
![球友拿到恒生电子的暑期实习了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250317163123.png)球友拿到恒生电子的暑期实习了
...
![xyZGHio：Redo Log Block](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250318160752.png)xyZGHio：Redo Log Block
...
![greatsql：redo log buffer的写入](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250318152808.png)greatsql：redo log buffer的写入
...
![xyZGHio：buf_next_to_write](https://cdn.paicoding.com/stutymore/mysql-20250318180850.png)xyZGHio：buf_next_to_write
...
![xyZGHio：MTR 与 Redo Log Buffer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250318163110.png)xyZGHio：MTR 与 Redo Log Buffer
...
![xyZGHio：MTR](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250318163310.png)xyZGHio：MTR
...
![greatsql：Redo Log Block](https://cdn.paicoding.com/stutymore/mysql-20250318154904.png)greatsql：Redo Log Block
...
![西维蜀黍：Redo Log 工作原理](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250318155855.png)西维蜀黍：Redo Log 工作原理
...
![xyZGHio：LSN](https://cdn.paicoding.com/stutymore/mysql-20250318181133.png)xyZGHio：LSN
...
![二哥的 Java 进阶之路：LSN](https://cdn.paicoding.com/stutymore/mysql-20250319161213.png)二哥的 Java 进阶之路：LSN
...
![读者已经把面渣逆袭彩印了，好漂亮啊](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250319163123.png)读者已经把面渣逆袭彩印了，好漂亮啊
...
![三分恶面渣逆袭：checkpoint 和 write pos](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-8d944e76-89ba-4fa6-9066-64ff4f55b532.jpg)三分恶面渣逆袭：checkpoint 和 write pos
...
![三分恶面渣逆袭：write pos 和 checkpoint](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-31a14149-b261-45d9-bd3b-6afaec16e136.jpg)三分恶面渣逆袭：write pos 和 checkpoint
...
![球友拿到了滴滴的测开实习 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250320163641.png)球友拿到了滴滴的测开实习 offer
...
![二哥的 Java 进阶之路：long_query_time](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240327083506.png)二哥的 Java 进阶之路：long_query_time
...
![三个猪皮匠：SQL 执行过程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240327083838.png)三个猪皮匠：SQL 执行过程
...
![二哥的java 进阶之路：技术派当前正在执行的 sql](https://cdn.paicoding.com/stutymore/mysql-20241115145204.png)二哥的java 进阶之路：技术派当前正在执行的 sql
...
![二哥的Java 进阶之路：技术派会在日志中记录请求的执行时间](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241115145401.png)二哥的Java 进阶之路：技术派会在日志中记录请求的执行时间
...
![球友报喜说拿到了 wxg 的实习 offer](https://cdn.paicoding.com/stutymore/mysql-20250321155611.png)球友报喜说拿到了 wxg 的实习 offer
...
![沉默王二：SQL 优化](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240327104050.png)沉默王二：SQL 优化
...
![梦里花。：回表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250322095940.png)梦里花。：回表
...
![球友进入腾讯云的 HR 面了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250322103527.png)球友进入腾讯云的 HR 面了
...
![二哥的 Java 进阶之路：子查询的执行计划](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250323213511.png)二哥的 Java 进阶之路：子查询的执行计划
...
![二哥的 Java 进阶之路：JOIN 的执行计划](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250323213756.png)二哥的 Java 进阶之路：JOIN 的执行计划
...
![球友对星球的一种褒奖](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250323214034.png)球友对星球的一种褒奖
...
![极客时间：Index Nested-Loop Join](https://cdn.paicoding.com/stutymore/mysql-20250324121435.png)极客时间：Index Nested-Loop Join
...
![极客时间：Block Nested-Loop Join](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250324121526.png)极客时间：Block Nested-Loop Join
...
![二哥的 Java 进阶之路：join_buffer_size](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250324152505.png)二哥的 Java 进阶之路：join_buffer_size
...
![贴一段球友对这个问题的分析](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250326213442.png)贴一段球友对这个问题的分析
...
![二哥的 Java 进阶之路：join 的验证，创建两个表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250324155729.png)二哥的 Java 进阶之路：join 的验证，创建两个表
...
![二哥的 Java 进阶之路：join 的执行计划](https://cdn.paicoding.com/stutymore/mysql-20250324155453.png)二哥的 Java 进阶之路：join 的执行计划
...
![阿里开发手册：MySQL 规约之 JOIN 多表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250324163735.png)阿里开发手册：MySQL 规约之 JOIN 多表
...
![球友拿到腾讯的暑期 offer+1](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250324163940.png)球友拿到腾讯的暑期 offer+1
...
![二哥的 Java 进阶之路：sort 的一些参数](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250326213740.png)二哥的 Java 进阶之路：sort 的一些参数
...
![二哥的 Java 进阶之路：filesort](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250326220036.png)二哥的 Java 进阶之路：filesort
...
![二哥的 Java 进阶之路：验证 filesort](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250326220632.png)二哥的 Java 进阶之路：验证 filesort
...
![二哥的 Java 进阶之路：filesort 的执行计划](https://cdn.paicoding.com/stutymore/mysql-20250326220857.png)二哥的 Java 进阶之路：filesort 的执行计划
...
![球友拿到阿里云的意向书了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-阿里云给意向书了.png)球友拿到阿里云的意向书了
...
![二哥的 Java 进阶之路：索引排序](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250327164223.png)二哥的 Java 进阶之路：索引排序
...
![极客时间：全字段排序](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250327172128.png)极客时间：全字段排序
...
![极客时间：rowid 排序](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250327171803.png)极客时间：rowid 排序
...
![二哥的 Java 进阶之路：Sort_merge_passes](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250327173629.png)二哥的 Java 进阶之路：Sort_merge_passes
...
![一树一溪：归并排序](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250327174147.png)一树一溪：归并排序
...
![有球友拿到快手的 offer 了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250327174927.png)有球友拿到快手的 offer 了
...
![球友字节和腾讯都 OC了](https://cdn.paicoding.com/stutymore/mysql-20250328155527.png)球友字节和腾讯都 OC了
...
![三分恶面渣逆袭：EXPLAIN](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-e234658f-5672-4a8d-9a75-872b305a171d.jpg)三分恶面渣逆袭：EXPLAIN
...
![二哥的 Java 进阶之路：explain json 格式](https://cdn.paicoding.com/stutymore/mysql-20250329103010.png)二哥的 Java 进阶之路：explain json 格式
...
![二哥的 Java 进阶之路：explain 结果](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240417092646.png)二哥的 Java 进阶之路：explain 结果
...
![球友美团 offer 口头oc 了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250329111600.png)球友美团 offer 口头oc 了
...
![三分恶面渣逆袭：索引加快查询远离](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-6b9c9901-9bf3-46ed-a5c4-c1b781965c1e.jpg)三分恶面渣逆袭：索引加快查询远离
...
![MySQL 索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250330123726.png)MySQL 索引
...
![二哥的 Java 进阶之路：有索引和没有索引的查询效率](https://cdn.paicoding.com/stutymore/mysql-20250330124012.png)二哥的 Java 进阶之路：有索引和没有索引的查询效率
...
![二哥的 Java 进阶之路：创建 index 的验证表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250330124209.png)二哥的 Java 进阶之路：创建 index 的验证表
...
![二哥的 Java 进阶之路：插入数据](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250330124250.png)二哥的 Java 进阶之路：插入数据
...
![二哥的 Java 进阶之路：对比有索引和没有索引的差别](https://cdn.paicoding.com/stutymore/mysql-20250330124502.png)二哥的 Java 进阶之路：对比有索引和没有索引的差别
...
![球友拿到了淘天的暑期实习](https://cdn.paicoding.com/stutymore/mysql-20250330170053.png)球友拿到了淘天的暑期实习
...
![二哥的 Java 进阶之路：索引类型](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240311225809.png)二哥的 Java 进阶之路：索引类型
...
![processon：主键索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250331165636.png)processon：主键索引
...
![二哥的 Java 进阶之路：MySQL 官方文档隐藏主键](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250331165053.png)二哥的 Java 进阶之路：MySQL 官方文档隐藏主键
...
![二哥的 Java 进阶之路：索引信息](https://cdn.paicoding.com/stutymore/mysql-20240312090221.png)二哥的 Java 进阶之路：索引信息
...
![二哥的 Java 进阶之路：主键索引和唯一索引](https://cdn.paicoding.com/stutymore/mysql-20250331171518.png)二哥的 Java 进阶之路：主键索引和唯一索引
...
![二哥的 Java 进阶之路：unique key 和 unique index](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250331174044.png)二哥的 Java 进阶之路：unique key 和 unique index
...
![球友拿到了淘天的暑期实习 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-厉害的，恭喜啊.png)球友拿到了淘天的暑期实习 offer
...
![二哥的 Java 进阶之路：中文分词](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250401152220.png)二哥的 Java 进阶之路：中文分词
...
![技术派：ES 实现查询](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250401145923.png)技术派：ES 实现查询
...
![二哥编程星球的球友拿到美团实习 offer 了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250401155231.png)二哥编程星球的球友拿到美团实习 offer 了
...
![二哥的 Java 进阶之路：小表的全表扫描比索引会更快](https://cdn.paicoding.com/stutymore/mysql-20250402144634.png)二哥的 Java 进阶之路：小表的全表扫描比索引会更快
...
![二哥的 Java 进阶之路：小表在索引和全表扫描时的结果](https://cdn.paicoding.com/stutymore/mysql-20250402144804.png)二哥的 Java 进阶之路：小表在索引和全表扫描时的结果
...
![球友拿到了百度的实习 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250402160141.png)球友拿到了百度的实习 offer
...
![用户1260737：B+树](https://cdn.paicoding.com/stutymore/mysql-20240322142950.png)用户1260737：B+树
...
![William Johnson：b+树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241104203402.png)William Johnson：b+树
...
1. 推荐阅读：[ ">终于把 B 树搞明白了](https://paicoding.com/column/11/
...
![二哥的 Java 进阶之路：B 树](https://cdn.paicoding.com/stutymore/mysql-20240322132606.png)二哥的 Java 进阶之路：B 树
...
![二哥的 Java 进阶之路：IO 读写](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240322133650.png)二哥的 Java 进阶之路：IO 读写
...
![用户1260737：二叉树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240322140825.png)用户1260737：二叉树
...
![用户1260737：B 树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240322141957.png)用户1260737：B 树
...
![死磕 Java：B+树](https://cdn.paicoding.com/stutymore/mysql-20250403113413.png)死磕 Java：B+树
...
![Brand博客园：B+树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250403114455.png)Brand博客园：B+树
...
![孤独烟：B树](https://cdn.paicoding.com/stutymore/mysql-20240516125249.png)孤独烟：B树
...
![孤独烟：B+树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240516125326.png)孤独烟：B+树
...
![球友收到美团 offer 了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250403120541.png)球友收到美团 offer 了
...
![清幽之地：B+树存储数据条数](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-16f3523d-20b0-4376-908d-ac40b329768f.jpg)清幽之地：B+树存储数据条数
...
![二哥的 Java 进阶之路：GitHub源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250404125013.png)二哥的 Java 进阶之路：GitHub源码
...
![yifanSJ：3 层 B+树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250404105416.png)yifanSJ：3 层 B+树
...
![球友问英文版的面炸逆袭](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-请问有英文翻译版的吗.png)球友问英文版的面炸逆袭
...
![二哥的Java 进阶之路：普通二叉树](https://cdn.paicoding.com/stutymore/mysql-20241115151059.png)二哥的Java 进阶之路：普通二叉树
...
![二哥的Java 进阶之路：AVL 树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241115151729.png)二哥的Java 进阶之路：AVL 树
...
![极客时间：B 树](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240325115614.png)极客时间：B 树
...
![极客时间：B+树](https://cdn.paicoding.com/stutymore/mysql-20240325115641.png)极客时间：B+树
...
- [GitHub：B 树和 B+树详解](https://github.com/wardseptember/notes/blob/master/docs/B树和B+树详解.md)
...
其中 N 是数据总量，m 是阶数。每层需要做一次二分查找，复杂度为 O(log⁡m)*O*(log*m*)。

总复杂度为：

O(log⁡mN⋅log⁡m)=O(log⁡N)*O*(log*m**N*⋅log*m*)=*O*(log*N*)
...
![dunwu：跳表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250405105517.png)dunwu：跳表
...
![oi-wiki：查找 45](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241223114806.png)oi-wiki：查找 45
...
![oi-wiki：从根节点开始](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241223114907.png)oi-wiki：从根节点开始
...
![oi-wiki：找到 45](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241223115300.png)oi-wiki：找到 45
...
快速排序使用分治法将一个序列分为较小和较大的 2 个子序列，然后递归排序两个子序列，由[东尼·霍尔](https://zh.wikipedia.org/wiki/東尼·霍爾)在 1960 年提出。



![维基百科：快速排序](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-Sorting_quicksort_anim.gif)维基百科：快速排序
...
![一颗剽悍的种子：B+树的结构](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240312092745.png)一颗剽悍的种子：B+树的结构
...
![业余码农：哈希索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240312094537.png)业余码农：哈希索引
...
![二哥的 Java 进阶之路](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240312095811.png)二哥的 Java 进阶之路
...
![代码敲上天.：聚簇索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240311231652.png)代码敲上天.：聚簇索引
...
![代码敲上天.非聚簇索引，以 age 为索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240311231611.png)代码敲上天.非聚簇索引，以 age 为索引
...
![球友夸二哥的简历修改的好](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250405114505.png)球友夸二哥的简历修改的好
...
![梦里花。：InnoDB 回表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250406120133.png)梦里花。：InnoDB 回表
...
![Brand：回表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250408110030.png)Brand：回表
...
![极客时间：MRR](https://cdn.paicoding.com/stutymore/mysql-20250406125740.png)极客时间：MRR
...
![二哥的 Java 进阶之路：MRR](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250406121543.png)二哥的 Java 进阶之路：MRR
...
![二哥的 Java 进阶之路：MRR 的缓冲区](https://cdn.paicoding.com/stutymore/mysql-20250406122130.png)二哥的 Java 进阶之路：MRR 的缓冲区
...
![二哥的 Java 进阶之路：MRR 开启时的前后对比](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250406124955.png)二哥的 Java 进阶之路：MRR 开启时的前后对比
...
![二哥的 Java 进阶之路：MRR 的测试结果说明](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250406125155.png)二哥的 Java 进阶之路：MRR 的测试结果说明
...
![二哥的 Java 进阶之路：使用聚簇索引时触发了 MRR](https://cdn.paicoding.com/stutymore/mysql-20250406141028.png)二哥的 Java 进阶之路：使用聚簇索引时触发了 MRR
...
![技术派如何写到简历上模板](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250406142139.png)技术派如何写到简历上模板
...
![Yxh_blogs：联合索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250407152038.png)Yxh_blogs：联合索引
...
![好奇的7号：联合索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250407155043.png)好奇的7号：联合索引
...
![mutest：联合索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250407160853.png)mutest：联合索引
...
![球友拿到了腾讯天美的后台开发 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250408105425.png)球友拿到了腾讯天美的后台开发 offer
...
![Brand：覆盖索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250408110120.png)Brand：覆盖索引
...
![三分恶面渣逆袭：联合索引](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-e348203c-f00a-42a4-a745-b219d98ea435.jpg)三分恶面渣逆袭：联合索引
...
![二哥的Java 进阶之路：最左前缀匹配的差异](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241105120556.png)二哥的Java 进阶之路：最左前缀匹配的差异
...
![二哥的 Java 进阶之路：explain中也可以明确看出来用了索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241115153445.png)二哥的 Java 进阶之路：explain中也可以明确看出来用了索引
...
![二哥的 Java 进阶之路：rows 为 10 行，说明全表扫描了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241115153552.png)二哥的 Java 进阶之路：rows 为 10 行，说明全表扫描了
...
![二哥的 Java 进阶之路：rows 为 9 行说明的确走索引了，但还需要额外过滤](https://cdn.paicoding.com/stutymore/mysql-20241115153636.png)二哥的 Java 进阶之路：rows 为 9 行说明的确走索引了，但还需要额外过滤
...
![二哥的 Java 进阶之路：验证是否走联合索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240315140807.png)二哥的 Java 进阶之路：验证是否走联合索引
...
![二哥的 Java 进阶之路：bc没有命中联合索引](https://cdn.paicoding.com/stutymore/mysql-20240408092425.png)二哥的 Java 进阶之路：bc没有命中联合索引
...
![二哥的 Java 进阶之路：c不会命中联合索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240408092646.png)二哥的 Java 进阶之路：c不会命中联合索引
...
![二哥的java 进阶之路：联合索引前缀通配符](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241104212447.png)二哥的java 进阶之路：联合索引前缀通配符
...
![二哥的java 进阶之路：6 行数据](https://cdn.paicoding.com/stutymore/mysql-20241104212743.png)二哥的java 进阶之路：6 行数据
...
![二哥的java 进阶之路：联合索引后缀通配符](https://cdn.paicoding.com/stutymore/mysql-20241104213135.png)二哥的java 进阶之路：联合索引后缀通配符
...
![Echo Blog：索引下推](https://cdn.paicoding.com/stutymore/mysql-20250408150326.png)Echo Blog：索引下推
...
![三分恶面渣逆袭：没有使用 ICP](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-c58f59e0-850b-4dfd-8129-2dfc51cf4768.jpg)三分恶面渣逆袭：没有使用 ICP
...
![三分恶面渣逆袭：使用 ICP](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-a8525cf3-2d16-49a9-a7da-a19762ed16df.jpg)三分恶面渣逆袭：使用 ICP
...
![二哥的 Java 进阶之路：开启 ICP 和关闭 ICP 的查询语句](https://cdn.paicoding.com/stutymore/mysql-20250408152401.png)二哥的 Java 进阶之路：开启 ICP 和关闭 ICP 的查询语句
...
![二哥的 Java 进阶之路：开启 ICP前后的结果对比](https://cdn.paicoding.com/stutymore/mysql-20250408152547.png)二哥的 Java 进阶之路：开启 ICP前后的结果对比
...
![二哥的 Java 进阶之路：性能差距](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250408153010.png)二哥的 Java 进阶之路：性能差距
...
![二哥的 Java 进阶之路：explain 和索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240417092646.png)二哥的 Java 进阶之路：explain 和索引
...
![二哥的 Java 进阶之路：ac 会用到联合索引的一部分](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240319131120.png)二哥的 Java 进阶之路：ac 会用到联合索引的一部分
...
![二哥的 Java 进阶之路：bc 无法命中索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240319131245.png)二哥的 Java 进阶之路：bc 无法命中索引
...
![二哥的 Java 进阶之路：acb 会命中索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240319131306.png)二哥的 Java 进阶之路：acb 会命中索引
...
![球友拿到了腾讯和美团的 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250408155951.png)球友拿到了腾讯和美团的 offer
...
![三分恶面渣逆袭：MySQL 中的锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-a07e4525-ccc1-4287-aec5-ebf3f277857c.jpg)三分恶面渣逆袭：MySQL 中的锁
...
![IServise：表级锁](https://cdn.paicoding.com/stutymore/mysql-20250411093212.png)IServise：表级锁
...
![Draven：共享锁和独占锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250410121135.png)Draven：共享锁和独占锁
...
![周二鸭：表锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250409144701.png)周二鸭：表锁
...
![周二鸭：行锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250409150234.png)周二鸭：行锁
...
![球友拿到了美团的暑期实习 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250409152600.png)球友拿到了美团的暑期实习 offer
...
![东平的笔记仓库：记录锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250410114455.png)东平的笔记仓库：记录锁
...
![X1aoHei：间隙锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250410114820.png)X1aoHei：间隙锁
...
![三分恶面渣逆袭：间隙锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-d60f3a42-4b0f-4612-b7ad-65191fecb852.jpg)三分恶面渣逆袭：间隙锁
...
![二哥的Java 进阶之路：间隙锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241215095640.png)二哥的Java 进阶之路：间隙锁
...
![小徐先生的编程世界：临键锁](https://cdn.paicoding.com/stutymore/mysql-20250410121613.png)小徐先生的编程世界：临键锁
...
![IServise：临键锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250411094421.png)IServise：临键锁
...
![球友学院本拿到了滴滴的 SP](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-等一手经验贴分享，发个红包，哈哈.png)球友学院本拿到了滴滴的 SP
...
![三分恶面渣逆袭：意向锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-31f7f49c-1e5a-4d42-b8b3-e022b3ba82ae.jpg)三分恶面渣逆袭：意向锁
...
![IServise：意向锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250411093326.png)IServise：意向锁
...
![球友给面渣逆袭上了口碑](https://cdn.paicoding.com/stutymore/mysql-主要我看的几个八股都是结合起来的.png)球友给面渣逆袭上了口碑
...
![牧小农：悲观锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250411092155.png)牧小农：悲观锁
...
![牧小农：悲观锁的处理思路](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250411092536.png)牧小农：悲观锁的处理思路
...
![牧小农：乐观锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250411092610.png)牧小农：乐观锁
...
![牧小农：的实现方式](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250411094551.png)牧小农：的实现方式
...
![牧小农：乐观锁的实现方式](https://cdn.paicoding.com/stutymore/mysql-20250411094932.png)牧小农：乐观锁的实现方式
...
![球友进入京东的 HR 面了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250411101319.png)球友进入京东的 HR 面了
...
![draven.co：死锁的发生](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413095712.png)draven.co：死锁的发生
...
![二哥的 Java 进阶之路：死锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241201101426.png)二哥的 Java 进阶之路：死锁
...
![二哥的 Java 进阶之路：查看死锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241201101704.png)二哥的 Java 进阶之路：查看死锁
...
![北野新津：ACID](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413102346.png)北野新津：ACID
...
![二哥的 Java 进阶之路：读未提交下出现脏读](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413155703.png)二哥的 Java 进阶之路：读未提交下出现脏读
...
![二哥的 Java 进阶之路：读已提交可以解决脏读问题](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413160617.png)二哥的 Java 进阶之路：读已提交可以解决脏读问题
...
![二哥的 Java 进阶之路：读已提交会出现不可重复读的问题](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413162654.png)二哥的 Java 进阶之路：读已提交会出现不可重复读的问题
...
![二哥的 Java 进阶之路：可重复读级别解决不可重复读的问题](https://cdn.paicoding.com/stutymore/mysql-20250413162908.png)二哥的 Java 进阶之路：可重复读级别解决不可重复读的问题
...
![二哥的 Java 进阶之路：可重复读级别下可能出现幻读](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413171035.png)二哥的 Java 进阶之路：可重复读级别下可能出现幻读
...
![二哥的 Java 进阶之路：串行化隔离级别下不会出现幻读问题](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413171627.png)二哥的 Java 进阶之路：串行化隔离级别下不会出现幻读问题
...
![Mayank Sharma：可持久化](https://cdn.paicoding.com/stutymore/mysql-20250413172141.png)Mayank Sharma：可持久化
...
![球友的彩虹屁真的太猛了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-二哥您好，麻烦您帮忙改一下简历，二哥真是配享太庙的男人.png)球友的彩虹屁真的太猛了
...
![二哥的 Java 进阶之路：ACID 的保证机制](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20230919103025.png)二哥的 Java 进阶之路：ACID 的保证机制
...
![小许 code：undo log保证原子性](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414121841.png)小许 code：undo log保证原子性
...
![小许 code：redo log 的 WAL，Write-Ahead Logging](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414154202.png)小许 code：redo log 的 WAL，Write-Ahead Logging
...
![BookSea：Doublewrite](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414154539.png)BookSea：Doublewrite
...
![一树一溪：2PC](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414155206.png)一树一溪：2PC
...
![小许 code：Checkpoint](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414154331.png)小许 code：Checkpoint
...
![阿里云社区：临键锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414162829.png)阿里云社区：临键锁
...
![小余哥：ReadView](https://cdn.paicoding.com/stutymore/mysql-20250414171111.png)小余哥：ReadView
...
![二哥的 Java 进阶之路：@@autocommit](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414171920.png)二哥的 Java 进阶之路：@@autocommit
...
![昨天有球友发帖说拿到了字节、美团的暑期实习 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250414172446.png)昨天有球友发帖说拿到了字节、美团的暑期实习 offer
...
![draven.co：事务的四个隔离级别](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250413100533.png)draven.co：事务的四个隔离级别
...
![易尘埃：读未提交](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250415152542.png)易尘埃：读未提交
...
![易尘埃：读已提交](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250415152926.png)易尘埃：读已提交
...
![易尘埃：可重复读](https://cdn.paicoding.com/stutymore/mysql-20250415153434.png)易尘埃：可重复读
...
![易尘埃：串行化](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250415153614.png)易尘埃：串行化
...
![二哥的 Java 进阶之路：快照读和当前读的差别](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250415162326.png)二哥的 Java 进阶之路：快照读和当前读的差别
...
![allaroundjava：Read uncommitted](https://cdn.paicoding.com/stutymore/mysql-20250416112357.png)allaroundjava：Read uncommitted
...
![allaroundjava：Read committed](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250416114215.png)allaroundjava：Read committed
...
![allaroundjava：Repeatable read](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250416115217.png)allaroundjava：Repeatable read
...
![球友拿到了京东的暑期实习 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250417215132.png)球友拿到了京东的暑期实习 offer
...
![Jenny：Phantom read](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250417222847.png)Jenny：Phantom read
...
![二哥的 Java 进阶之路：可以发现产生幻读了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250417222448.png)二哥的 Java 进阶之路：可以发现产生幻读了
...
![二哥的 Java 进阶之路：临键锁能防止幻读](https://cdn.paicoding.com/stutymore/mysql-20250417223640.png)二哥的 Java 进阶之路：临键锁能防止幻读
...
![转转技术：临键锁](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250418102139.png)转转技术：临键锁
...
![二哥的 Java 进阶之路：只用快照读](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250417224334.png)二哥的 Java 进阶之路：只用快照读
...
![Keep It Simple：Read View](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250418103117.png)Keep It Simple：Read View
...
![溪水静幽：当前读](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250418102600.png)溪水静幽：当前读
...
![爱吃鱼饼的猫：快照读](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250418105347.png)爱吃鱼饼的猫：快照读
...
![球友拿到了蚂蚁暑期实习 offer](https://cdn.paicoding.com/stutymore/mysql-20250418105609.png)球友拿到了蚂蚁暑期实习 offer
...
![天瑕：undo log 版本链和 ReadView](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241215073837.png)天瑕：undo log 版本链和 ReadView
...
![guozhchun：额外的存储信息](https://cdn.paicoding.com/stutymore/mysql-20250419152549.png)guozhchun：额外的存储信息
...
![luozhiyun：ReadView](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250419152750.png)luozhiyun：ReadView
...
![二哥的 Java 进阶之路：版本链](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240415084347.png)二哥的 Java 进阶之路：版本链
...
![三分恶面渣逆袭：DB_ROLL_PTR](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-80ebc2b3-ae63-417d-9307-f6a7811f7965.jpg)三分恶面渣逆袭：DB_ROLL_PTR
...
![三分恶面渣逆袭：update 操作](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-bf4ff00d-01bd-4170-a17b-6919f7873ea4.jpg)三分恶面渣逆袭：update 操作
...
![三分恶面渣逆袭：版本链](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-765b3d83-14eb-4b56-8940-9d60bfaf1737.jpg)三分恶面渣逆袭：版本链
...
![二哥的 Java 进阶之路：ReadView](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240415093703.png)二哥的 Java 进阶之路：ReadView
...
![二哥的 Java 进阶之路：ReadView判断规则](https://cdn.paicoding.com/stutymore/mysql-20240415094939.png)二哥的 Java 进阶之路：ReadView判断规则
...
![小许 code：可见性匹配规则](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250419162341.png)小许 code：可见性匹配规则
...
![程序员x：readview 在可重复读和读已提交下的不同](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250419163740.png)程序员x：readview 在可重复读和读已提交下的不同
...
![球友拿到了拼多多的 offer](https://cdn.paicoding.com/stutymore/mysql-20250419164013.png)球友拿到了拼多多的 offer
...
![三分恶面渣逆袭：读写分离](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-31df767c-db05-4de4-a05b-a45bcf76c1bf.jpg)三分恶面渣逆袭：读写分离
...
![轻风博客：主从同步](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250420153404.png)轻风博客：主从同步
...
![三分恶面渣逆袭：业务代码封装](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-771eb01f-3f1a-4437-8e1b-affe4de36ec3.jpg)三分恶面渣逆袭：业务代码封装
...
![三分恶面渣逆袭：数据库中间件](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-f2313613-25bd-4065-8f63-969a4b5757a7.jpg)三分恶面渣逆袭：数据库中间件
...
![鲲鹏：Mycat for MySQL 读写分离](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250420160540.png)鲲鹏：Mycat for MySQL 读写分离
...
![三分恶面渣逆袭：主从复制](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-1bfbfcb5-2392-4f98-be1b-a66204da09e5.jpg)三分恶面渣逆袭：主从复制
...
![骏马金龙：半同步复制](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250420164609.png)骏马金龙：半同步复制
...
![球友已经把星球安利给了同门](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250420170230.png)球友已经把星球安利给了同门
...
![三分恶面渣逆袭：垂直分库](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-2a43af18-617b-4502-b66a-894c2ff4c6c3.jpg)三分恶面渣逆袭：垂直分库
...
![三分恶面渣逆袭：水平分库](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/mysql-debe0fb1-d7f7-4ef2-8c99-13c9377138b6.jpg)三分恶面渣逆袭：水平分库
...
![三分恶面渣逆袭：表拆分](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-7cba6ce0-c8bb-4f51-9c3b-e5a44e724c79.jpg)三分恶面渣逆袭：表拆分
...
![二哥的 Java 进阶之路：文章和详情垂直分表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250422152008.png)二哥的 Java 进阶之路：文章和详情垂直分表
...
![三分恶面渣逆袭：范围分片](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-b3882ca3-1d04-44e2-9015-7e6c867255a0.jpg)三分恶面渣逆袭：范围分片
...
![三分恶面渣逆袭：Hash 分片](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-e01e7757-c337-48c8-95db-2f7cfd2bc036.jpg)三分恶面渣逆袭：Hash 分片
...
![三分恶面渣逆袭：配置路由](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-fcd34332-d38d-455a-875d-d4afd37cac72.jpg)三分恶面渣逆袭：配置路由
...
![拿到蚂蚁 offer 的球友对星球口碑+1 了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250422153403.png)拿到蚂蚁 offer 的球友对星球口碑+1 了
...
![三分恶面渣逆袭：数据同步和校验](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-2d4d94c9-e816-47fc-93dd-a835b1318099.jpg)三分恶面渣逆袭：数据同步和校验
...
![三分恶面渣逆袭：下线旧库](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-a122d6d5-fff2-4ccd-8ddb-a9282eb2e2da.jpg)三分恶面渣逆袭：下线旧库
...
![AWS：Sharding-JDBC](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241207120214.png)AWS：Sharding-JDBC
...
![piwenfei：mycat](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241207121845.png)piwenfei：mycat
...
![PmHub 项目中 Seata](https://cdn.paicoding.com/stutymore/mysql-20250423110330.png)PmHub 项目中 Seata
...
![京东的 JD-hotkey](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250423111247.png)京东的 JD-hotkey
...
![技术派：自定义雪花算法算法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20241223150915.png)技术派：自定义雪花算法算法
...
![技术派：雪花算法](https://cdn.paicoding.com/stutymore/mysql-20241223150351.png)技术派：雪花算法
...
![vivo 暑期实习 offer](https://cdn.paicoding.com/stutymore/mysql-20250423111757.png)vivo 暑期实习 offer
...
![截图来自MySQL官网：由腾讯游戏 DBA 团队贡献](https://cdn.paicoding.com/stutymore/mysql-20250424114631.png)截图来自MySQL官网：由腾讯游戏 DBA 团队贡献
...
![top -pid $(pgrep mysqld)](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250424120022.png)top -pid $(pgrep mysqld)
...
![球友拿到小鹏汽车的测试 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250424120308.png)球友拿到小鹏汽车的测试 offer
...
![二哥的 Java 进阶之路：找出age=18的记录](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240410105325.png)二哥的 Java 进阶之路：找出age=18的记录
...
![二哥的 Java 进阶之路：找出年龄大于 18 的人](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240410105512.png)二哥的 Java 进阶之路：找出年龄大于 18 的人
...
![二哥的 Java 进阶之路：排名前两名的学生](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240410105951.png)二哥的 Java 进阶之路：排名前两名的学生
...
![二哥的 Java 进阶之路：先索引再插入](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240412083019.png)二哥的 Java 进阶之路：先索引再插入
...
![二哥的 Java 进阶之路：先插入再索引](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240412083312.png)二哥的 Java 进阶之路：先插入再索引
...
![家长对星球的认可](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-老师您好，今天孩子和我通话语气都精神起来.png)家长对星球的认可
...
![二哥的 Java 进阶之路：排名前十](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20240423113508.png)二哥的 Java 进阶之路：排名前十
...
![二哥的 Java 进阶之路：窗口函数](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250426150253.png)二哥的 Java 进阶之路：窗口函数
...
![球友拿到蚂蚁国际的 offer 发来的感谢信](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/mysql-20250427102433.png)球友拿到蚂蚁国际的 offer 发来的感谢信