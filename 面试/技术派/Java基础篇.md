...
![詹姆斯高斯林-下辈子还学 Java，还头秃](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/one-01.png)詹姆斯高斯林-下辈子还学 Java，还头秃
...
![pmhub](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/1719412227941-391d1ca0-e312-4e81-a958-2eff29dbecd7.png)
...
![MYDB](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20241223085416.png)
...
![三分恶面渣逆袭：Java语言特点](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-2.png)
...
![三分恶面渣逆袭：Java程序执行过程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-4.png)
...
![三分恶面渣逆袭：编译与解释](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-5.png)

## 基础语法

### 7.🌟Java 有哪些数据类型？

> 推荐阅读 1：[Java 的数据类型](https://javabetter.cn/basic-grammar/basic-data-type.html) 推荐阅读 2：[面试官竟然问我这么简单的题目：Java 中 boolean 占多少字节？](https://mp.weixin.qq.com/s/KMDlAf5sXQCn8LJz-RJRgA)

Java 的数据类型可以分为两种：**基本数据类型**和**引用数据类型**。

![二哥的 Java 进阶之路：Java数据类型](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/nine-01.png)
...
> 派聪明简历写法：https://paicoding.com/column/10/2



![蚂蚁转正的球友对派聪明的认可](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20250926113204.png)蚂蚁转正的球友对派聪明的认可
...
![三分恶面渣逆袭：Java自动类型转换方向](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javase-7.png)三分恶面渣逆袭：Java自动类型转换方向
...
![三分恶面渣逆袭:装箱和拆箱](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-8.png)三分恶面渣逆袭:装箱和拆箱
...
![break 、continue 、return](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-9.png)break 、continue 、return
...
- S：符号位，0 代表正数，1 代表负数；
- M：尾数部分，用于表示数值的精度；比如说 1.25∗221.25∗22；1.25 就是尾数；
- R：基数，十进制中的基数是 10，二进制中的基数是 2；
- E：指数部分，例如 10−110−1 中的 -1 就是指数。
...
![kaito：浮点数](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240321112428.png)kaito：浮点数
...
3. 用二进制科学计数法表示：25.125 = 1.001001×241.001001×24

符号位 S 是 0，表示正数；指数部分 E 是 4，转换为二进制是 100；尾数部分 M 是 1.001001。



![kaito：25.125](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240321113232.png)kaito：25.125
...
![海外留学生](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20250926113917.png)海外留学生
...
![三分恶面渣逆袭：面向对象和面向过程的区别](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-10.png)三分恶面渣逆袭：面向对象和面向过程的区别
...
![技术派实战项目源码截图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20241111172421.png)技术派实战项目源码截图
...
![二哥的 Java 进阶之路：封装继承多态](https://cdn.paicoding.com/stutymore/javase-20240330115129.png)二哥的 Java 进阶之路：封装继承多态
...
![截图来自博客园的小牛呼噜噜：虚拟方法表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20241126104207.png)截图来自博客园的小牛呼噜噜：虚拟方法表
...
![二哥的 Java 进阶之路](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/21-01.png)二哥的 Java 进阶之路
...
![里氏替换原则由芭芭拉·利斯科夫提出，照片摄于2010年](https://cdn.paicoding.com/stutymore/javase-20240321103119.png)里氏替换原则由芭芭拉·利斯科夫提出，照片摄于2010年
...
![拿到了招银的 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20250924154354.png)拿到了招银的 offer
...
![访问修饰符和可见性](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-12.png)访问修饰符和可见性
...
![二哥的 Java 进阶之路：接口不能定义构造方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240512090855.png)二哥的 Java 进阶之路：接口不能定义构造方法
...
![二哥的 Java 进阶之路：final 修饰类](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240415111236.png)二哥的 Java 进阶之路：final 修饰类
...
![二哥的 Java 进阶之路：不能更改](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240415111725.png)二哥的 Java 进阶之路：不能更改
...
![三分恶面渣逆袭：final修饰变量](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-13.png)三分恶面渣逆袭：final修饰变量
...
![二哥的 Java 进阶之路](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240407165712.png)
...
![二哥的 Java 进阶之路，String的equals()源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240425093626.png)
...
例如 [HashMap](https://javabetter.cn/collection/hashmap.html#_01、hash方法的原理) 中的 key 就是通过 hashCode 来实现的，通过调用 hashCode 方法获取键的哈希码，并将其与右移 16 位的哈希码进行异或运算。
...
![三分恶面渣逆袭：Java引用数据值传递示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-14.png)
...
![三分恶面渣逆袭：浅拷贝和深拷贝示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-15.png)三分恶面渣逆袭：浅拷贝和深拷贝示意图
...
![三分恶面渣逆袭：Java创建对象的四种方式](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-16.png)三分恶面渣逆袭：Java创建对象的四种方式
...
![三分恶面渣逆袭：堆与常量池中的String](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-17.png)三分恶面渣逆袭：堆与常量池中的String
...
![三分恶面渣逆袭：jdk1.8之前的字符串拼接](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-18.png)三分恶面渣逆袭：jdk1.8之前的字符串拼接
...
![二哥的 Java 进阶之路：integer 源码](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240323080956.png)二哥的 Java 进阶之路：integer 源码
...
![二哥的 Java 进阶之路：调整缓存池大小](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240323082802.png)二哥的 Java 进阶之路：调整缓存池大小
...
![parseInt示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20.png)parseInt示意图
...
![三分恶面渣逆袭：Object类的方法](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/javase-21.png)三分恶面渣逆袭：Object类的方法
...
![img](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240313085055.png)
...
![三分恶面渣逆袭：Java异常体系](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-22.png)三分恶面渣逆袭：Java异常体系
...
![三分恶面渣逆袭：异常处理](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-23.png)三分恶面渣逆袭：异常处理
...
![二哥的Java 进阶之路：catch 和 finally 处理异常](https://cdn.paicoding.com/stutymore/javase-20241008095737.png)二哥的Java 进阶之路：catch 和 finally 处理异常
...
![二哥的 Java 进阶之路](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/shangtou-01.png)二哥的 Java 进阶之路
...
![Java IO流用到装饰器模式](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-25.png)Java IO流用到装饰器模式
...
![球友拿到美团 offer 了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20250919160609.png)球友拿到美团 offer 了
...
![二哥的 Java 进阶之路：IO 分类](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20240404103618.png)二哥的 Java 进阶之路：IO 分类
...
![三分恶面渣逆袭：BIO](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-27.png)三分恶面渣逆袭：BIO
...
![三分恶面渣逆袭：NIO](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-28.png)三分恶面渣逆袭：NIO
...
![三分恶面渣逆袭：NIO完整示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-29.png)三分恶面渣逆袭：NIO完整示意图
...
![三分恶面渣逆袭：序列化和反序列化](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-30.png)三分恶面渣逆袭：序列化和反序列化
...
![Java常见序列化方式](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-31.png)Java常见序列化方式
...
![二哥的Java 进阶之路：一个简单的 socket 通信](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/socket-20230330192826.png)二哥的Java 进阶之路：一个简单的 socket 通信
...
![博客园struggler：经典的 RPC](https://cdn.paicoding.com/stutymore/javase-20241128182231.png)博客园struggler：经典的 RPC
...
![泛型类、泛型接口、泛型方法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-32.png)泛型类、泛型接口、泛型方法
...
![Java注解和帽子](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-33.png)Java注解和帽子
...
![Override注解](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-34.png)Override注解
...
![Autowired注解](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-35.png)Autowired注解
...
![三分恶面渣逆袭：Java反射相关类](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-36.png)三分恶面渣逆袭：Java反射相关类
...
![技术派：mapstruct](https://cdn.paicoding.com/stutymore/javase-20250927172849.png)技术派：mapstruct
...
![球友在星球里的成长](https://cdn.paicoding.com/stutymore/javase-20250927172411.png)球友在星球里的成长
...
![三分恶面渣逆袭：JDK1.8主要新特性](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-37.png)三分恶面渣逆袭：JDK1.8主要新特性
...
![Java Stream流](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-38.png)Java Stream流
...
![这是我在牛客上看到的](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20241230165717.png)这是我在牛客上看到的





![我觉得都是蛮中肯的评价](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/javase-20241230165749.png)我觉得都是蛮中肯的评价
...
![微信扫码或者长按识别，或者微信搜索“沉默王二”](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gongzhonghao.png)
...
![回复 222](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/collection-20250512160410.png)回复 222
