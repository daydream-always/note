...
![三分恶面渣逆袭：Java语言编译运行](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/jvm-1.png)三分恶面渣逆袭：Java语言编译运行
...
![截图来自美团技术：JIT](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jit-9a62fc02-1a6a-451e-bb2b-19fc086d5be0.png)截图来自美团技术：JIT
...
![三分恶面渣逆袭：JVM跨语言](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/jvm-2.png)三分恶面渣逆袭：JVM跨语言
...
![京东和华为 offer](https://cdn.paicoding.com/stutymore/jvm-20251106120847.png)京东和华为 offer
...
![截图来源于网络：jvm 的结构](https://cdn.paicoding.com/stutymore/what-is-jvm-20231030185742.png)截图来源于网络：jvm 的结构
...
![jvm vs os](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20251106124728.png)jvm vs os
...
![美团开奖白菜](https://cdn.paicoding.com/stutymore/jvm-团子今年好像给的都不高.jpg)美团开奖白菜
...
![三分恶面渣逆袭：Java虚拟机运行时数据区](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/jvm-3.png)三分恶面渣逆袭：Java虚拟机运行时数据区
...
![三分恶面渣逆袭：Java虚拟机栈](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-4.png)三分恶面渣逆袭：Java虚拟机栈
...
![二哥的 Java 进阶之路：javap emptyMethod](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240816130451.png)二哥的 Java 进阶之路：javap emptyMethod
...
![二哥的 Java 进阶之路：javap staticEmptyMethod](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240816130536.png)二哥的 Java 进阶之路：javap staticEmptyMethod
...
![二哥的Java 进阶之路：currentTimeMillis方法源码](https://cdn.paicoding.com/stutymore/jvm-20241020075744.png)二哥的Java 进阶之路：currentTimeMillis方法源码
...
![二哥的Java 进阶之路：hashCode方法源码](https://cdn.paicoding.com/stutymore/jvm-20241020080126.png)二哥的Java 进阶之路：hashCode方法源码
...
![二哥的 Java 进阶之路：堆](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/neicun-jiegou-20231225154450.png)二哥的 Java 进阶之路：堆
...
![三分恶面渣逆袭：Java 堆内存结构](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-5.png)三分恶面渣逆袭：Java 堆内存结构
...
![三分恶面渣逆袭：JDK 1.6内存区域](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-6.png)三分恶面渣逆袭：JDK 1.6内存区域
...
![三分恶面渣逆袭：JDK 1.7内存区域](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-7.png)三分恶面渣逆袭：JDK 1.7内存区域
...
![三分恶面渣逆袭：JDK 1.8内存区域](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-8.png)三分恶面渣逆袭：JDK 1.8内存区域
...
![二哥的 Java 进阶之路：对象的创建过程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240404091445.png)二哥的 Java 进阶之路：对象的创建过程
...
![二哥的 Java 进阶之路：JVM 使用的垃圾收集器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250110111618.png)二哥的 Java 进阶之路：JVM 使用的垃圾收集器
...
![暑期实习和秋招都拿下](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250925184546.png)暑期实习和秋招都拿下
...
![三分恶面渣逆袭：指针碰撞和空闲列表](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-10.png)三分恶面渣逆袭：指针碰撞和空闲列表
...
![Baeldung：堆抢占](https://cdn.paicoding.com/stutymore/jvm-20250111104638.png)Baeldung：堆抢占
...
![Baeldung：TLAB](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250111105119.png)Baeldung：TLAB
...
![二哥的 Java 进阶之路：查看 TLAB](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250111111537.png)二哥的 Java 进阶之路：查看 TLAB
...
![二哥的 Java 进阶之路：测试 TLAB](https://cdn.paicoding.com/stutymore/jvm-20250111111823.png)二哥的 Java 进阶之路：测试 TLAB
...
![二哥的 Java 进阶之路：关闭 TLAB](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250111112843.png)二哥的 Java 进阶之路：关闭 TLAB
...
![三分恶面渣逆袭：对象的存储布局](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/jvm-12.png)三分恶面渣逆袭：对象的存储布局
...
![二哥的 Java 进阶之路：查看 JVM 是否开启压缩指针](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240320220408.png)二哥的 Java 进阶之路：查看 JVM 是否开启压缩指针
...
![rickiyang：缓存行污染](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240320222058.png)rickiyang：缓存行污染
...
![rickiyang：000 结尾](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240320222631.png)rickiyang：000 结尾
...
![rickiyang：Java 对象模型](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240320221330.png)rickiyang：Java 对象模型
...
![二哥的 Java 进阶之路：JOL 运行结果](https://cdn.paicoding.com/stutymore/jvm-20240320223653.png)二哥的 Java 进阶之路：JOL 运行结果
...
![dijia478：对象头](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240320224701.png)dijia478：对象头
...
![二哥的 Java 进阶之路：对象的引用有多大？](https://cdn.paicoding.com/stutymore/jvm-20240320231059.png)二哥的 Java 进阶之路：对象的引用有多大？
...
![美团暑期转正了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-二哥，暑期拒了鹅客户端。团子现在拿到校招意向了～.png)美团暑期转正了
...
![三分恶面渣逆袭：通过句柄访问对象](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-13.png)三分恶面渣逆袭：通过句柄访问对象
...
![三分恶面渣逆袭：通过直接指针访问对象](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-14.png)三分恶面渣逆袭：通过直接指针访问对象
...
![三分恶面渣逆袭：四种引用总结](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-19.png)三分恶面渣逆袭：四种引用总结
...
![三分恶面渣逆袭：Java堆内存划分](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-21.png)三分恶面渣逆袭：Java堆内存划分
...
![三分恶面渣逆袭：新生代内存划分](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-25.png)三分恶面渣逆袭：新生代内存划分
...
![二哥的 Java 进阶之路：对象进入老年代](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240501093929.png)二哥的 Java 进阶之路：对象进入老年代
...
![二哥的 Java 进阶之路：年龄阈值](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250113095435.png)二哥的 Java 进阶之路：年龄阈值
...
![二哥的 Java 进阶之路：PretenureSizeThreshold](https://cdn.paicoding.com/stutymore/jvm-20250113102243.png)二哥的 Java 进阶之路：PretenureSizeThreshold
...
![有梦想的肥宅：G1](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gc-collector-20231228213824.png)有梦想的肥宅：G1
...
![二哥的 Java 进阶之路：UseG1GC](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250113103255.png)二哥的 Java 进阶之路：UseG1GC
...
![三分恶面渣逆袭：老王拉车只能在平路休息](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-33.png)三分恶面渣逆袭：老王拉车只能在平路休息



推荐大家看看这个[HotSpot JVM Deep Dive - Safepoint](https://www.youtube.com/watch?v=JkbWPPNc4SI)，对 safe point 有一个比较深入地解释。

![img](https://cdn.paicoding.com/stutymore/jvm-20250114142714.png)
...
![二哥的 Java 进阶之路：JVM 开启了逃逸分析](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250115162625.png)二哥的 Java 进阶之路：JVM 开启了逃逸分析
...
![三分恶面渣逆袭：方法逃逸](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-37.png)三分恶面渣逆袭：方法逃逸
...
![三分恶面渣逆袭：内存泄漏、内存溢出](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-15.png)三分恶面渣逆袭：内存泄漏、内存溢出
...
![二哥的 Java 进阶之路：添加 -Xmx128M VM 参数](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/neicun-jiegou-20231225160028.png)二哥的 Java 进阶之路：添加 -Xmx128M VM 参数
...
![二哥的 Java 进阶之路：堆内存溢出](https://cdn.paicoding.com/stutymore/neicun-jiegou-20231225160115.png)二哥的 Java 进阶之路：堆内存溢出
...
2. [JVM 性能监控工具之命令行篇](https://javabetter.cn/jvm/console-tools.html#jstack-跟踪java堆栈)
...
![二哥的 Java 进阶之路：jps 查看技术派的进程 ID](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806085955.png)二哥的 Java 进阶之路：jps 查看技术派的进程 ID
...
![二哥的 Java 进阶之路：top -p](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806090059.png)二哥的 Java 进阶之路：top -p
...
![二哥的 Java 进阶之路：top -Hp](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806090208.png)二哥的 Java 进阶之路：top -Hp
...
![二哥的 Java 进阶之路：jstack](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806091529.png)二哥的 Java 进阶之路：jstack
...
![二哥的 Java 进阶之路：另外一组线程 id 的堆栈](https://cdn.paicoding.com/stutymore/jvm-20240806092007.png)二哥的 Java 进阶之路：另外一组线程 id 的堆栈
...
![二哥的 Java 进阶之路：jstat](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806093011.png)二哥的 Java 进阶之路：jstat
...
![二哥的 Java 进阶之路：jstat](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806093107.png)二哥的 Java 进阶之路：jstat
...
![二哥的 Java 进阶之路：jmap](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806093153.png)二哥的 Java 进阶之路：jmap
...
![二哥的 Java 进阶之路：jmap](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/console-tools-20240106184317.png)二哥的 Java 进阶之路：jmap
...
![VisualVM](https://cdn.paicoding.com/stutymore/view-tools-20240107134238.png)VisualVM
...
![二哥的Java进阶之路：栈帧](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/stack-frame-20231224090450.png)二哥的Java进阶之路：栈帧
...
![二哥的 Java 进阶之路：可达性分析](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gc-20231227104036.png)二哥的 Java 进阶之路：可达性分析
...
![IT 宅：垃圾回收的过程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250922170756.png)IT 宅：垃圾回收的过程
...
![STW](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250922172410.png)STW
...
![球友加入星球以感谢面渣逆袭对他的帮助](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250922170910.png)球友加入星球以感谢面渣逆袭对他的帮助
...
![三分恶面渣逆袭：GC Root](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-18.png)三分恶面渣逆袭：GC Root
...
![三分恶面渣逆袭：引用计数法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-17.png)三分恶面渣逆袭：引用计数法
...
![二哥的 java 进阶之路：GC Roots](https://cdn.paicoding.com/stutymore/neicun-jiegou-20231227111238.png)二哥的 java 进阶之路：GC Roots
...
![pecuyu：动态链接](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gc-20240321085719.png)pecuyu：动态链接
...
![三分恶面渣逆袭：刀下留人](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20.png)三分恶面渣逆袭：刀下留人
...
![三分恶面渣逆袭：标记-清除算法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-22.png)三分恶面渣逆袭：标记-清除算法
...
![三分恶面渣逆袭：标记-复制算法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-23.png)三分恶面渣逆袭：标记-复制算法
...
![标记-整理算法](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/jvm-24.png)标记-整理算法
...
![二哥的 Java 进阶之路：Java 堆划分](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gc-20231227131241.png)二哥的 Java 进阶之路：Java 堆划分
...
![京东 sp和字节抖音电商 offer](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20251106130702.png)京东 sp和字节抖音电商 offer
...
![三分恶面渣逆袭：HotSpot虚拟机垃圾收集器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-28.png)三分恶面渣逆袭：HotSpot虚拟机垃圾收集器
...
![三分恶面渣逆袭：Serial/Serial Old收集器运行示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-29.png)三分恶面渣逆袭：Serial/Serial Old收集器运行示意图
...
![三分恶面渣逆袭：ParNew/Serial Old收集器运行示意图](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/jvm-30.png)三分恶面渣逆袭：ParNew/Serial Old收集器运行示意图
...
![三分恶面渣逆袭：吞吐量](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-31.png)三分恶面渣逆袭：吞吐量
...
![三分恶面渣逆袭：Parallel Old收集器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-32.png)三分恶面渣逆袭：Parallel Old收集器
...
![小潘：CMS](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gc-collector-20231228211056.png)小潘：CMS
...
![得物技术：指针染色](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gc-collector-20240102142908.png)得物技术：指针染色
...
![三分恶面渣逆袭：Concurrent Mark Sweep收集器运行示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-34.png)三分恶面渣逆袭：Concurrent Mark Sweep收集器运行示意图
...
![Java全栈架构师：三色标记法](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240816132235.png)Java全栈架构师：三色标记法
...
![有梦想的肥宅：G1 收集器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/gc-collector-20231228213824.png)有梦想的肥宅：G1 收集器
...
![三分恶面渣逆袭：G1收集器运行示意图](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-36.png)三分恶面渣逆袭：G1收集器运行示意图
...
![星球优惠完仅需 129 元，但提供项目、简历修改等各种溢价服务](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-记得来反馈进度，我给你调整.jpg)星球优惠完仅需 129 元，但提供项目、简历修改等各种溢价服务
...
![二哥的 Java 进阶之路：JDK 默认垃圾收集器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240613111454.png)二哥的 Java 进阶之路：JDK 默认垃圾收集器
...
![二哥的Java 进阶之路：jmap -heap](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240806093153.png)二哥的Java 进阶之路：jmap -heap
...
![二哥的Java 进阶之路：jmap -histo](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/console-tools-20240106185906.png)二哥的Java 进阶之路：jmap -histo
...
![二哥的Java 进阶之路：jmap -dump](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/console-tools-20240106184317.png)二哥的Java 进阶之路：jmap -dump
...
![三分恶面渣逆袭：JConsole概览](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-39.png)三分恶面渣逆袭：JConsole概览
...
![三分恶面渣逆袭：VisualVM安装插件](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-40.png)三分恶面渣逆袭：VisualVM安装插件
...
![三分恶面渣逆袭：JMC主要界面](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-41.png)三分恶面渣逆袭：JMC主要界面
...
![听劝很重要啊](https://cdn.paicoding.com/stutymore/jvm-20250923210204.png)听劝很重要啊
...
![二哥的 Java 进阶之路：JVM 调优](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240417094311.png)二哥的 Java 进阶之路：JVM 调优
...
![三分恶面渣逆袭：CPU飙高](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-43.png)三分恶面渣逆袭：CPU飙高
...
![haikuotiankongdong：top 命令结果](https://cdn.paicoding.com/stutymore/jvm-20240527111502.png)haikuotiankongdong：top 命令结果
...
![haikuotiankongdong：Java 进程中的线程情况](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20240527111356.png)haikuotiankongdong：Java 进程中的线程情况
...
![PmHub：Skywalking](https://cdn.paicoding.com/stutymore/jvm-20250925190010.png)PmHub：Skywalking
...
![硬件人也天天看二哥的文章](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250925185500.png)硬件人也天天看二哥的文章
...
![二哥的 Java 进阶之路：dump](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/console-tools-20240106184317.png)二哥的 Java 进阶之路：dump
...
![二哥的 Java 进阶之路：分析](https://cdn.paicoding.com/stutymore/view-tools-20240107134238.png)二哥的 Java 进阶之路：分析
...
![球友对星球和进阶之路的赞美](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-感谢二哥哈哈，面试遇到的差不多90.png)球友对星球和进阶之路的赞美
...
![darrenqiao：类加载器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250924160643.png)darrenqiao：类加载器
...
![类加载过程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/class-load-20231031202641.png)类加载过程
...
![京东 offer 了](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250924160802.png)京东 offer 了
...
![程序新视界：类加载器](https://cdn.paicoding.com/stutymore/jvm-20251106114027.png)程序新视界：类加载器
...
![JVM 和类加载器的关系](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20251106114437.png)JVM 和类加载器的关系
...
![三分恶面渣逆袭：类的生命周期](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-44.png)三分恶面渣逆袭：类的生命周期
...
![三分恶面渣逆袭：载入](https://cdn.paicoding.com/tobebetterjavaer/images/sidebar/sanfene/jvm-45.png)三分恶面渣逆袭：载入
...
![三分恶面渣逆袭：双亲委派模型](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-46.png)三分恶面渣逆袭：双亲委派模型
...
![三分恶面渣逆袭：双亲委派模型的三次破坏](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-47.png)三分恶面渣逆袭：双亲委派模型的三次破坏
...
![拿到了哈啰实习](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-20250924162337.png)拿到了哈啰实习
...
![Tomcat类加载器](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-48.png)Tomcat类加载器
...
![图片来源于美团技术博客](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jit-9a62fc02-1a6a-451e-bb2b-19fc086d5be0.png)图片来源于美团技术博客
