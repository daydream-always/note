...
[Guide](https://javaguide.cn/article/)JavaJava基础约 14016 字大约 47 分钟

[![JavaGuide官方知识星球](E:/下载/Java基础常见面试题总结(上) _ JavaGuide_files/xingqiu.png)](https://javaguide.cn/about-the-author/zhishixingqiu-two-years.html)
...
### [⭐️JVM vs JDK vs JRE](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️jvm-vs-jdk-vs-jre)
...
![运行在 Java 虚拟机之上的编程语言](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/java-virtual-machine-program-language-os.png)
...
![img](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/JavaSeSpecifications.jpg)

#### [JDK 和 JRE](https://javaguide.cn/java/basis/java-basic-questions-01.html#jdk-和-jre)
...
![jdk-include-jre](E:/下载/Java基础常见面试题总结(上) _ JavaGuide_files/jdk-include-jre.png)
...
### [⭐️什么是字节码?采用字节码的好处是什么?](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️什么是字节码-采用字节码的好处是什么)

在 Java 中，JVM 可以理解的代码就叫做字节码（即扩展名为 `.class` 的文件），它不面向任何特定的处理器，只面向虚拟机。Java  语言通过字节码的方式，在一定程度上解决了传统解释型语言执行效率低的问题，同时又保留了解释型语言可移植的特点。所以， Java  程序运行时相对来说还是高效的（不过，和 C、 C++，Rust，Go  等语言还是有一定差距的），而且，由于字节码并不针对一种特定的机器，因此，Java 程序无须重新编译便可在多种不同操作系统的计算机上运行。

**Java 程序从源代码到运行的过程如下图所示**：

![Java程序转变为机器代码的过程](E:/下载/Java基础常见面试题总结(上) _ JavaGuide_files/java-code-to-machine-code.png)
...
![Java程序转变为机器代码的过程](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/java-code-to-machine-code-with-jit.png)

> HotSpot 采用了惰性评估(Lazy Evaluation)的做法，根据二八定律，消耗大部分系统资源的只有那一小部分的代码（热点代码），而这也就是 JIT 所需要编译的部分。JVM 会根据代码每次被执行的情况收集信息并相应地做出一些优化，因此执行的次数越多，它的速度就越快。

JDK、JRE、JVM、JIT 这四者的关系如下图所示。

![JDK、JRE、JVM、JIT 这四者的关系](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jdk-jre-jvm-jit.png)

下面这张图是 JVM 的大致结构模型。

![JVM 的大致结构模型](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/jvm-rough-structure-model.png)

### [⭐️为什么说 Java 语言“编译与解释并存”？](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️为什么说-java-语言-编译与解释并存)
...
![编译型语言和解释型语言](E:/下载/Java基础常见面试题总结(上) _ JavaGuide_files/compiled-and-interpreted-languages.png)
...
![JIT vs AOT](E:/下载/Java基础常见面试题总结(上) _ JavaGuide_files/jit-vs-aot.png)
...
![oracle jdk release cadence](E:/下载/Java基础常见面试题总结(上) _ JavaGuide_files/oracle-jdk-release-cadence.jpg)
...
![img](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/image-20220714112336911.png)
...
### [⭐️自增自减运算符](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️自增自减运算符)
...
### [⭐️移位运算符](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️移位运算符)
...
## [⭐️基本数据类型](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️基本数据类型)
...
![img](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/up-1ae0425ce8646adfb768b5374951eeb820d.png)
...
### [⭐️成员变量与局部变量的区别？](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️成员变量与局部变量的区别)

![img](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/java-basis-variables-member-variable-vs-local-variable.png)
...
![img](https://gitee.com/CHENKAIforyou/image-bed/raw/master/imag/java-basis-variables-static-variable.png)
...
### [⭐️静态方法和实例方法有何不同？](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️静态方法和实例方法有何不同)
...
### [⭐️重载和重写有什么区别？](https://javaguide.cn/java/basis/java-basic-questions-01.html#⭐️重载和重写有什么区别)

> 重载就是同样的一个方法能够根据输入数据的不同，做出不同的处理
>
> 重写就是当子类继承自父类的相同方法，输入数据一样，但要做出有别于父类的响应时，你就要覆盖父类方法

#### [重载](https://javaguide.cn/java/basis/java-basic-questions-01.html#重载)
...
#### [重写](https://javaguide.cn/java/basis/java-basic-questions-01.html#重写)
...
#### [总结](https://javaguide.cn/java/basis/java-basic-questions-01.html#总结)
...
## [参考](https://javaguide.cn/java/basis/java-basic-questions-01.html#参考)
...
## [写在最后](https://javaguide.cn/java/basis/java-basic-questions-01.html#写在最后)
...
![JavaGuide 公众号](E:/下载/Java基础常见面试题总结(上) _ JavaGuide_files/gongzhonghao-javaguide.png)

最近更新: 2026/1/17 11:43